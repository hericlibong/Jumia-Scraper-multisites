...
class JumiaEgyptSpider(scrapy.Spider):
    ...
    cats_sen = ['telephone-tablette', 'electronique', 'maison-bureau-electromenager', 'beaute-hygiene-sante', 
                'ordinateurs-accessoires-informatique', 'fashion-mode', 
                'maison-cuisine-jardin', 'bebe-puericulture', 'sports-loisirs', 'jeux-videos-consoles']
    
    def start_requests(self):
        url= self.start_urls[0]
        for cat in self.cats_sen:
