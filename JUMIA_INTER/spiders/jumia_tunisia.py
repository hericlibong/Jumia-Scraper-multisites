...
class JumiaAlgeriaSpider(scrapy.Spider):
    name = "jumia_tunisia"
    allowed_domains = ["jumia.com.tn"]
    start_urls = ["https://www.jumia.com.tn/"]
    
    cats_tun = ['telephone-tablette', 'cuisine-cuisson', 'beaute-hygiene-sante', 'electronique', 'epicerie', 
                'fashion-mode', 'maison-cuisine-jardin', 'ordinateurs-accessoires-informatique', 
                'jeux-videos-consoles', 'sports-loisirs', 'terrasse-jardin-exterieur']

    def start_requests(self):
        url= self.start_urls[0]
        for cat in self.cats_tun:
