...
class JumiaEgyptSpider(scrapy.Spider):
    ...
    cats_mor = ['telephone-tablette', 'electronique', 'ordinateurs-accessoires-informatique', 
                'maison-cuisine-jardin', 'fashion-mode', 'beaute-hygiene-sante', 
                'jeux-videos-consoles', 'sports-loisirs', 'bebe-puericulture', 'automobile-outils', 'epicerie']
    
    def start_requests(self):
        url= self.start_urls[0]
        for cat in self.cats_mor:
