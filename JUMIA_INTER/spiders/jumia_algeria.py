...
class JumiaAlgeriaSpider(scrapy.Spider):
    ...
    cats_alg = ['fashion-mode', 'electronique', 'beaute-hygiene-sante', 'maison-cuisine-jardin', 'telephone-tablette', 'ordinateurs-accessoires-informatique', 
                 'bebe-puericulture', 'mlp-jeux-jouets-gaming', 'sports-loisirs', 'epicerie', 
                 'automobile-outils']

    def start_requests(self):
        url= self.start_urls[0]
        for cat in self.cats_alg:
